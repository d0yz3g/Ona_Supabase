...
# Функция для регистрации обработчиков голосовых сообщений
def register_voice_handlers(dp):
    """
    Регистрирует все обработчики голосовых сообщений в диспетчере.
    
    Args:
        dp: Диспетчер
    """
    # Включаем роутер голосовых сообщений в диспетчер
    dp.include_router(voice_router)
    
    # Логируем успешную регистрацию
    logger.info("Обработчики голосовых сообщений успешно зарегистрированы") 