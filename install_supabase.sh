...
pip install gotrue-py==1.2.0 || echo "Warning: Failed to install gotrue-py"

echo "Installing postgrest-py..."
pip install postgrest-py==0.15.0 || echo "Warning: Failed to install postgrest-py"
...
pip install storage3==0.7.0 || echo "Warning: Failed to install storage3"

echo "Installing supafunc..."
pip install supafunc==0.3.1 || echo "Warning: Failed to install supafunc"

echo "Installing supabase-py..."
pip install supabase-py==2.3.5 || echo "Warning: Failed to install supabase-py"
